...
//    @Environment(\.managedObjectContext) var moc
    ...
    @Published var currentAnswers: [Int] = []
    ...
    func checkAnswers() {
        for answerID in currentAnswers {
            if questions[currentQuestionNumber].correctAnswers.contains(answerID+1) {
                correctBoolAnswers[answerID] = true
            }
        }
    }
